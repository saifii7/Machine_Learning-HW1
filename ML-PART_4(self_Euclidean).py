...
distances = ([custom_distance(query_point, x) for x in X_train])
# Finding the indices of the three nearest neighbors
k = 3
nearest_indices = np.argsort(distances)[:k]

# Corresponding data points in the training set:
...
print("Top_3 distance:",distances[:k])
